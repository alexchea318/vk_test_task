...
❗ Сайт протетсирован в браузерах Firefox, Edge, Chrome, Safari(iphone), Chrome Mobile(Android). Используются севрменные CSS свойства, работа в старых браузерах может быть некорректной.
